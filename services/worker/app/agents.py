...
def _design_prompt(
    *,
    ...
    return (
        ...
        "  Line 2 (METHOD): the field name METHOD followed by one or two sentences on how you will appraise the committed sources (must not be empty)\n"
...
def _revise_prompt(
    *,
    ...
    return (
        ...
        "Format spec:\n"
        "  Line 1 (QUESTION): the field name QUESTION followed by a one-sentence restatement of the clinical question\n"
        "  Line 2 (METHOD): the field name METHOD followed by one or two sentences (must not be empty)\n"
        "  Line 3 (SCOPE): the field name SCOPE followed by 'pop=A-B years=Y1-Y2' where A, B, Y1, Y2 are integers\n"
